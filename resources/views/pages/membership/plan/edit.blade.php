                                                ...
                                                <div class="card-body border-top p-9">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text" name="plan" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Plan" value="{{ $member->plan }}"/>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="text" name="description" class="form-control form-control-lg form-control-solid" placeholder="Company name" value="{{ $member->description }}"/>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="text" name="points" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="{{ $member->points }}"/>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="text" name="currency" class="form-control form-control-lg form-control-solid" placeholder="Currency" value="{{ $member->currency }}"/>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <!--begin::Col-->
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="number" name="points" class="form-control form-control-lg form-control-solid" placeholder="Price" value="{{ $member->price }}"/>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Input group-->
