...
<div class="d-flex flex-column flex-root">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        <!--begin::Form-->
        <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ route('user-manager.update') }}" enctype="multipart/form-data">
        @csrf
        @method('put')
        <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label  fw-bold fs-6">{{ __('Approval') }}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <select name="role" aria-label="{{ __('Select a Currency') }}" data-control="select2" data-placeholder="{{ __('Select Approval/Reject') }}" class="form-select form-select-solid form-select-lg">
                            <option value="">{{ __('Select approval') }}</option>
                                    <option data-kt-flag="" value="4"
                                    @if($user->role==4)
                                         selected
                                    @endif
                                         ><b>Approve as Potential</b></option>
                                    <option data-kt-flag="" value="7"
                                    @if($user->role==7)
                                         selected
                                    @endif
                                         ><b>Approve as Member</b></option>

                                    <option data-kt-flag="" value="6"
                                    @if($user->role==6)
                                         selected
                                    @endif
                                    ><b>Rejected</b></option>
