        ...
        <div class="card-body pt-6">
            ...
            <tbody>
                @foreach ($roles as $role)
                    ...
                    <td class="flex"><form action="/user-management/roles/edit" method="GET">
                        <input type="hidden" value="{{ $role->id }}" name="id" />
                        <button type="submit" value="{{ $role->id }}" class="btn btn-alert" >Edit</button>
                        </form>&nbsp;&nbsp;&nbsp;<form action="/user-management/roles/delete" method="POST" value="{{ $role->id }}" ><button class=" btn btn-danger">Delete</button></form>
